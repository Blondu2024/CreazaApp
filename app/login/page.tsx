    ...
    <div className="min-h-screen bg-[#0a0a0f] flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-[400px] bg-[#111118] border border-[rgba(30,30,46,0.8)] rounded-2xl p-8">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 h-11 bg-white text-[#111118] rounded-lg font-medium text-sm hover:bg-gray-100 transition-colors mb-4"
        >
