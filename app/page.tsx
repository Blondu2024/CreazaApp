    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-20 pb-32 px-6 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="mt-16 relative">
            ...
            <div className="relative bg-card rounded-2xl border border-border p-1 shadow-2xl shadow-[#6366f1]/10">
              <div className="flex items-center gap-2 px-4 py-3 border-b border-border">
                ...
                <div className="flex-1 flex justify-center">
                  <div className="bg-background px-4 py-1 rounded-md text-xs text-muted-foreground">creazaapp.com/workspace</div>
                </div>
              </div>
              <div className="grid grid-cols-3 gap-1 p-1 h-[300px] sm:h-[380px]">
                ...
                <div className="bg-background rounded-lg p-4 flex flex-col">
                  ...
                  <div className="flex-1 space-y-2.5">
                    <div className="bg-card rounded-lg p-2.5 text-[11px] text-foreground">Fa-mi un landing page pentru o cafenea cu meniu si galerie</div>
                    <div className="bg-gradient-to-r from-[#6366f1]/20 to-[#a855f7]/20 rounded-lg p-2.5 text-[11px] text-foreground">
                ...
                {/* Code + Preview panel */}
                <div className="bg-background rounded-lg p-4 col-span-2 flex flex-col">
                  <div className="flex items-center gap-2 mb-3">
                    <div className="bg-card px-3 py-1 rounded text-[11px] text-foreground border border-border"><span className="text-[#3b82f6] mr-1">&#9679;</span>App.jsx</div>
                    <div className="px-3 py-1 rounded text-[11px] text-muted-foreground"><span className="text-[#a855f7] mr-1">&#9679;</span>styles.css</div>
                    <div className="ml-auto px-3 py-1 rounded text-[11px] bg-[#10b981]/10 text-[#10b981] border border-[#10b981]/20">Preview</div>
                  </div>
                  <div className="flex-1 font-mono text-[11px] text-muted-foreground space-y-1 overflow-hidden">
                    <p><span className="text-[#c084fc]">const</span> {"{"} <span className="text-foreground">useState</span> {"}"} = <span className="text-foreground">React</span>;</p>
                    <p></p>
                    <p><span className="text-[#c084fc]">function</span> <span className="text-[#f59e0b]">App</span>() {"{"}</p>
                    <p className="pl-4"><span className="text-[#c084fc]">const</span> [<span className="text-foreground">menu</span>, <span className="text-foreground">setMenu</span>] = <span className="text-[#f59e0b]">useState</span>(<span className="text-[#10b981]">&apos;cafea&apos;</span>);</p>
                    <p className="pl-4"><span className="text-[#c084fc]">return</span> (</p>
                    <p className="pl-8">&lt;<span className="text-[#3b82f6]">div</span> <span className="text-foreground">className</span>=<span className="text-[#10b981]">&quot;min-h-screen&quot;</span>&gt;</p>
                    <p className="pl-12">&lt;<span className="text-[#3b82f6]">nav</span> <span className="text-foreground">className</span>=<span className="text-[#10b981]">&quot;flex...&quot;</span>&gt;</p>
      ...
      <section className="py-12 px-6 border-y border-border">
        <div className="max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">In limba romana</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-foreground mb-4">Cum functioneaza</h2>
            <p className="text-muted-foreground">Trei pasi. Zero configurare. Zero experienta necesara.</p>
          </div>
      ...
      <section id="functionalitati" className="py-24 px-6 bg-[#070710]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-foreground mb-4">Tot ce ai nevoie intr-un singur loc</h2>
            <p className="text-muted-foreground max-w-xl mx-auto">De la idee la aplicatie functionala in minute, nu in zile</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, index) => (
              <div key={index} className="bg-card rounded-xl border border-border p-6 hover:border-[#6366f1]/50 transition-all duration-200 group">
      ...
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-foreground mb-4">Alege modelul potrivit</h2>
            <p className="text-muted-foreground">Cele mai puternice AI-uri, selectate automat pentru planul tau</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {models.map((m) => (
              <div key={m.name} className="bg-card rounded-xl border border-border p-4 hover:border-[#6366f1]/30 transition-colors text-center">
          ...
          <p className="text-center text-xs text-muted-foreground mt-6">+ Llama, DeepSeek, Mistral, si multe altele</p>
        </div>
      </section>
      ...
      <section className="py-24 px-6 bg-[#070710]">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-foreground mb-4">Preturi simple</h2>
            <p className="text-muted-foreground">Platesti doar cat folosesti. 50 credite gratuite la start.</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {plans.map((p) => (
              <div key={p.name} className={`rounded-xl p-5 text-center ${p.popular ? "bg-gradient-to-b from-[#6366f1]/15 to-[#a855f7]/15 border-2 border-[#6366f1]" : "bg-card border border-border"}`}>
                {p.popular && <span className="text-[10px] font-bold text-[#6366f1] tracking-wider">POPULAR</span>}
                <p className="text-lg font-semibold text-foreground mt-1">{p.name}</p>
                <p className="text-2xl font-bold text-foreground my-2">{p.price} <span className="text-sm font-normal text-muted-foreground">RON</span></p>
      ...
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-3xl font-semibold text-foreground mb-4">De ce CreazaApp</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-6">
              ...
              <h3 className="font-semibold text-foreground mb-2">Fara surprize</h3>
              <p className="text-sm text-muted-foreground">Preturi transparente. 50 credite gratuite la inregistrare, apoi platesti cat folosesti.</p>
            </div>
            <div className="text-center p-6">
              ...
              <h3 className="font-semibold text-foreground mb-2">In limba romana</h3>
              <p className="text-sm text-muted-foreground">Interfata, agentul AI, si suportul — totul in romana. Fara bariere de limba.</p>
            </div>
            <div className="text-center p-6">
              <div className="w-12 h-12 rounded-xl bg-[#f59e0b]/10 flex items-center justify-center mx-auto mb-4">
                <Clock className="w-6 h-6 text-[#f59e0b]" />
              </div>
              <h3 className="font-semibold text-foreground mb-2">Rapid</h3>
              <p className="text-sm text-muted-foreground">De la descriere la aplicatie functionala in sub 5 minute. Fara setup, fara configurare.</p>
            </div>
          </div>
        </div>
      </section>
