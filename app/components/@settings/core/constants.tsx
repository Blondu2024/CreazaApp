...
export const TAB_LABELS: Record<TabType, string> = {
  ...
  features: 'Funcții',
  data: 'Date & Stocare',
  'cloud-providers': 'Provideri Cloud',
  'local-providers': 'Provideri Locali',
  github: 'GitHub',
  gitlab: 'GitLab',
  netlify: 'Netlify',
  vercel: 'Vercel',
  supabase: 'Supabase',
  'event-logs': 'Jurnale Evenimente',
  mcp: 'Servere MCP',
};

export const TAB_DESCRIPTIONS: Record<TabType, string> = {
  profile: 'Gestionează profilul și setările contului',
  settings: 'Configurează preferințele aplicației',
  notifications: 'Vezi și gestionează notificările',
  features: 'Explorează funcțiile noi',
  data: 'Gestionează datele și stocarea',
  'cloud-providers': 'Configurează providerii AI cloud',
  'local-providers': 'Configurează providerii AI locali',
  github: 'Conectează și gestionează GitHub',
  gitlab: 'Conectează și gestionează GitLab',
  netlify: 'Configurează deploy-ul Netlify',
  vercel: 'Gestionează proiectele Vercel',
  supabase: 'Configurează conexiunea Supabase',
  'event-logs': 'Vezi evenimentele sistemului',
  mcp: 'Configurează serverele MCP',
};
