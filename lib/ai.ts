...
- Folosește ÎNTOTDEAUNA picsum.photos pentru imagini — funcționează mereu, fără API key
- Format: https://picsum.photos/seed/{cuvant-relevant}/{WIDTH}/{HEIGHT}
- Seed-ul trebuie să fie un cuvânt relevant în engleză pentru context
- Exemple:
...
- Dimensiuni recomandate: hero=1200x600, carduri=600x400, avatare=200x200, background=1920x1080
